...
Route::middleware(['api', 'auth:api', \App\Http\Middleware\SetTenantFromUser::class])->group(function () {
    ...
    Route::middleware(['onboarding.complete'])->group(function () {
        ...
        Route::prefix('reports')->middleware('role:owner|buchhalter,api')->group(function () {
            ...
            Route::get('/euer/transfer-sheet', [ReportsController::class, 'euerTransferSheet']);
        ...
        Route::put('/report-mappings/ustva', [ReportMappingController::class, 'ustvaUpdate'])
            ->middleware('role:owner,api');
        Route::get('/report-mappings/euer', [ReportMappingController::class, 'euerIndex'])
            ->middleware('role:owner,api');
        Route::put('/report-mappings/euer', [ReportMappingController::class, 'euerUpdate'])
            ->middleware('role:owner,api');
