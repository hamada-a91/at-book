    ...
    useEffect(() => {
        if (settings) {
            form.reset({
                ...
                module_inventory_enabled: settings.module_inventory_enabled !== undefined ? settings.module_inventory_enabled : true,
            });
        ...
        <div className="space-y-6 max-w-5xl mx-auto pb-12">
            ...
            <Tabs defaultValue={searchParams.get('tab') || 'general'} className="space-y-6">
                <TabsList className="bg-slate-100 dark:bg-slate-800 p-1 rounded-xl">
                    <TabsTrigger value="general" className="rounded-lg data-[state=active]:bg-white dark:data-[state=active]:bg-slate-950 data-[state=active]:shadow-sm">Allgemein</TabsTrigger>
                    {!fromOnboarding && (
                        <>
                            <TabsTrigger value="account-plan" className="rounded-lg data-[state=active]:bg-white dark:data-[state=active]:bg-slate-950 data-[state=active]:shadow-sm">Kontenplan</TabsTrigger>
                            <TabsTrigger value="backup" className="rounded-lg data-[state=active]:bg-white dark:data-[state=active]:bg-slate-950 data-[state=active]:shadow-sm">Backup</TabsTrigger>
                        </>
                    )}
                </TabsList>
                ...
                {!fromOnboarding && (
                    <>
                        <TabsContent value="account-plan" className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                            <AccountPlanManagement />
                        </TabsContent>
                        <TabsContent value="backup" className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                            <BackupManagement />
                        </TabsContent>
                    </>
                )}
