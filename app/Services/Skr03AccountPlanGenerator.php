...
class Skr03AccountPlanGenerator
{
    ...
    private function getBaseAccounts(): array
    {
        return [
            ...
            // Häufig benötigte Aufwandskonten (SPEC: allgemeine Kontenerweiterung)
            [
                'code' => '4909',
                'name' => 'Aufwendungen für Fremdlizenzen / Rechte',
                'type' => 'expense',
                'category' => 'Sonstige Kosten',
                'skr03_class' => 4,
                'account_purpose' => 'income_statement',
                'default_tax_code' => 'VST19',
                'default_tax_rate' => 19,
            ...
            [
                'code' => '4922',
                'name' => 'Internet- / Telekommunikationskosten',
                'type' => 'expense',
                'category' => 'Sonstige Kosten',
                'skr03_class' => 4,
                'account_purpose' => 'income_statement',
            ...
            [
                'code' => '4670',
                'name' => 'Reise- und Übernachtungskosten',
                'type' => 'expense',
                'category' => 'Werbe-/Reisekosten',
                'skr03_class' => 4,
                'account_purpose' => 'income_statement',
            ...
            [
                'code' => '4950',
                'name' => 'Rechts- und Beratungskosten (Anwalt/Steuerberater)',
                'type' => 'expense',
                'category' => 'Sonstige Kosten',
                'skr03_class' => 4,
                'account_purpose' => 'income_statement',
