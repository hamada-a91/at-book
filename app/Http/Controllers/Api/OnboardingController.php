...
class OnboardingController extends Controller
{
    ...
    public function complete()
    {
        ...
        // SPEC-07 (7.3): Cache-Invalidierung, damit die nächste geschützte
        // Route sofort (nicht erst nach bis zu 1h TTL) erreichbar ist. Der
        // saved()-Hook auf CompanySetting (siehe App\Models\CompanySetting)
        // deckt das bereits ab - explizit hier zusätzlich, um die Absicht am
        // Ort der Statusänderung sichtbar zu dokumentieren.
        Cache::forget(OnboardingMiddleware::cacheKey($tenant->id));
